...
class EmployeeCatalogApp:
    def __init__(self, page: flet.Page):
        ...
        self.page.win_width = 1000
        self.page.win_height = 1200
    ...
    def build_ui(self):
        self.page.add(flet.Text("Каталог сотрудников компании", size=25, weight='bold'))

        self.first_name = flet.TextField(label="Имя сотрудника", width=450)
        self.last_name = flet.TextField(label='Фамилия', width=450)
        self.age = flet.TextField(label='Возраст', width=450, keyboard_type=flet.KeyboardType.NUMBER)
        ...
        self.salary = flet.TextField(label='Зарплата (сом.)', width=450, keyboard_type=flet.KeyboardType.NUMBER)

        self.result_text = flet.Text(size=18)
